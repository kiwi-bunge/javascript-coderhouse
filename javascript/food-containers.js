...
const showFoodContainers = document.getElementById("food-containers");
...
function loadEventListeners() {
    ...
    showFoodContainers.addEventListener("click", addToCart);
...
function foodContainersSection() {

    fetch("javascript/products-stock-data.json")
        .then(response => response.json())
        .then(data => {

            const myfoodcontainers = data.filter(function(products) {
                return products.category === "food-containers" 
            });
            
            myfoodcontainers.forEach (product => {
                ...
                showFoodContainers.appendChild(div);
        });
    });
};
