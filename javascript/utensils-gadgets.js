...
const showUtensilsGadgets = document.getElementById("utensils-gadgets");
...
function loadEventListeners() {
    ...
    showUtensilsGadgets.addEventListener("click", addToCart);
...
function utensilsGadgetsSection() {

    fetch("javascript/products-stock-data.json")
        .then(response => response.json())
        .then(data => {

            const myUtensils = data.filter(function(products) {
                return products.category === "utensils-gadgets" 
            });
            
            myUtensils.forEach (product => {
                ...
                showUtensilsGadgets.appendChild(div);
        });
    });
};
